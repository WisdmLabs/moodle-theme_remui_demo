...
define('local_edwiserpagebuilder/components-imagegallery', ['local_edwiserpagebuilder/jquery', 'core/ajax'], function (jQuery, Ajax) {
    ...
    function addBlocks(blocks) {
        ...
        Vvveb.Components.extend("_base", "html/slider15", {
            ...
            html: (() => {
                return `<div title="Image-slider-with-text-2" class="data-ebpb-slider15" data-vvveb-disabled-area contenteditable="false">${sliderhtml15}<style>${slidercss15}</style><script>${sliderjs15}</script></div>`;
            })(),
            beforeInit: function (node) {
                properties = [];
                var i = 0;
