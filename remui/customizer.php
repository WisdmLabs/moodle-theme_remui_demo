...
$PAGE->requires->js_call_amd('theme_remui/demo_general', 'initDemoCustomizer');
...
$templatecontext->democontext = new stdClass();
$templatecontext->democontext->demomodaldatajson = json_encode(\theme_remui\utility::get_demo_modal_data());
