...
(() => {
    ...
    function r(t) {
        void 0 === t && (t = 1),
            document.querySelectorAll("h1,h2,h3,h4,h5,h6,p,a,dl,dt,li,ol,th,td,span,blockquote,.asw-text").forEach(function (e) {
                var i;
                if (!e.classList.contains("material-icons") && !e.classList.contains("fa") && !e.closest('.demo-navbar')) {
    ...
    var h = function (t, e, i) {
        ...
        p = ["", "*:not(.material-icons, .icon, .edw-icon,.asw-menu,.asw-menu *, button.emoji-button, .info-about-box-wrapper p, .demo-navbar, .demo-navbar *)"],
        m = ["h1", "h2", "h3", "h4", "h5", "h6", ".wsite-headline", ".wsite-content-title"],
        v = h(h([], m, !0), ["img", "p:not(.info-about-box-wrapper p, .demo-navbar p)", "i:not(.fa,.edw-icon,.icon)", "svg", "a:not(.demo-navbar a)", "button:not(.asw-btn, .fa, .demo-navbar button)", "label:not(.demo-navbar label)", "li:not(.demo-navbar li)", "ol:not(.demo-navbar ol)"], !1),
    ...
    var k = function () {
        ...
        A = {
            ...
            childrenSelector: (function (t, e, i) {
                ...
                "*:not(.material-icons,.fa,fa-*,.edw-icon,.demo-navbar)",
                "span:not(.material-icons,.fa,.edw-icon,.icon,.demo-navbar span, [class^='vjs'])",
                "td:not(.demo-navbar td)",
                "tr:not(.demo-navbar tr)",
                "#course-stats",
                ".edw-stats-wrapper",
                "span.categoryname",
                ".edwiser-categories *:not(i.fa)",
                ".edwiser-courses *:not(i.fa)",
                ".review-approval-container",
                ".lesson-date-wrapper",
                ".modal-dialog",
                ".toast-message",
                '.popover-region-content'], v, !0),
            styles: {
