...
class __Mustache_8355b3512b7016345309f304333902bd extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_overview_section')) {
            $context->pushBlockContext(array(
                ...
                'emptymessage' => array($this, 'block22768e0ddfe60d2e0023bc5e2449496a'),
            ));
...
';
    ...
    public function block22768e0ddfe60d2e0023bc5e2449496a($context)
    {
        $indent = $buffer = '';
