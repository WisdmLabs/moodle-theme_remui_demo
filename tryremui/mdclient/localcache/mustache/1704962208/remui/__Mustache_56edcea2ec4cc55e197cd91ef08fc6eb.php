...
class __Mustache_56edcea2ec4cc55e197cd91ef08fc6eb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="p-p-6  bg-white" data-region="confirm-dialogue" role="alert">
';
        $buffer .= $indent . '    <p class="" data-region="dialogue-text"></p>
';
