...
class __Mustache_1dbbce5d2ddc94b822f86f7e5c1bc6fc extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_overview_section')) {
            $context->pushBlockContext(array(
                ...
                'emptymessage' => array($this, 'blockFc059046fa33c81999249dd462ee897a'),
            ));
...
';
    ...
    public function blockFc059046fa33c81999249dd462ee897a($context)
    {
        $indent = $buffer = '';
