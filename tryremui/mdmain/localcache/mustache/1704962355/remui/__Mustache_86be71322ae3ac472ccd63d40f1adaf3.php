...
class __Mustache_86be71322ae3ac472ccd63d40f1adaf3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2c9f182fd3c9be2d0dbebcc6a11076c5($context, $indent, $value);
...
';
        ...
        $buffer .= ' r-my-6" data-for="sectioninfo">
';
...
';
    ...
    private function section2c9f182fd3c9be2d0dbebcc6a11076c5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '<div class="flex-fill d-flex justify-content-end align-self-center collapse-all-menu">
';
                $buffer .= $indent . '    <a
';
                $buffer .= $indent . '        id="collapsesections"
';
                $buffer .= $indent . '        class="section-collapsemenu small-info-semibold"
';
                $buffer .= $indent . '        href="#"
';
