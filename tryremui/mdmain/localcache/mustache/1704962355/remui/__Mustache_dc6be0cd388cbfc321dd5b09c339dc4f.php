...
class __Mustache_dc6be0cd388cbfc321dd5b09c339dc4f extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="content-message-container hidden h-100 p-p-6" data-region="content-message-container" role="log" style="overflow-y: auto; overflow-x: hidden">
';
