...
class __Mustache_72072649cd0660c96d9b8e44b4a3e8a2 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <form class="mform clearfix  m-0">
';
        $buffer .= $indent . '        <div class="form-group d-flex flex-gap-1 p-0">
';
        $buffer .= $indent . '            <button class="fp-file-download btn btn-secondary btn-sm">';
        $value = $context->find('str');
        $buffer .= $this->section95ff3701934939e1eb7bd2c28e3ee1b9($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '            <button class="fp-file-delete btn btn-secondary btn-sm">';
        $value = $context->find('str');
        $buffer .= $this->section8f92e409dad2d31675245b12b8825d4e($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '            <button class="fp-file-setmain btn btn-secondary btn-sm">';
        $value = $context->find('str');
...
';
        ...
        $buffer .= '</span>
';
        $buffer .= $indent . '            <button class="fp-file-zip btn btn-secondary btn-sm">';
        $value = $context->find('str');
        $buffer .= $this->sectionB38288f316bd094496a8d2cfdfaa803d($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '            <button class="fp-file-unzip btn btn-secondary btn-sm">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '                <div class="fp-saveas form-group row mx-0 p-0 d-flex align-items-center">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4 px-0 m-0 edw-form-label">';
        $value = $context->find('str');
        $buffer .= $this->section59a2a4641027716ff85403c2d5e94fc1($context, $indent, $value);
        $buffer .= '</label>
';
        $buffer .= $indent . '                    <div class="col-8 form-inline p-0"><input class="form-control" type="text"/></div>
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-author form-group row mx-0 p-0 d-flex align-items-center">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4 px-0 m-0 edw-form-label">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-license form-group row mx-0 p-0 d-flex align-items-center">
';
        ...
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-path form-group row mx-0 p-0 d-flex align-items-center">
';
        $buffer .= $indent . '                    <label class="form-control-label col-4 px-0 m-0 edw-form-label">';
        $value = $context->find('str');
        ...
        $buffer .= '</label>
';
        $buffer .= $indent . '                    <div class="col-8 form-inline p-0">
';
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-original form-group row mx-0 p-0 ">
';
        $buffer .= $indent . '                    <div class="form-control-label col-4 px-0 m-0 edw-form-label">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '                <div class="fp-reflist form-group row mx-0 p-0">
';
        $buffer .= $indent . '                    <div class="form-control-label col-4 px-0 m-0 edw-form-label">';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '        <div class="fp-select-buttons form-group p-0 w-100 text-right p-mb-6 d-flex flex-row-reverse flex-gap-1">
';
        $buffer .= $indent . '            <button class="fp-file-update btn-primary btn btn-lg">';
        $value = $context->find('str');
        $buffer .= $this->section47d66f004044b857c042bbdf70fe2cc2($context, $indent, $value);
        $buffer .= '</button>
';
        $buffer .= $indent . '            <button class="fp-file-cancel btn-secondary btn btn-lg">';
        $value = $context->find('str');
