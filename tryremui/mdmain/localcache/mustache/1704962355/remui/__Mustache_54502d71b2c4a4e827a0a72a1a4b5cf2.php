...
class __Mustache_54502d71b2c4a4e827a0a72a1a4b5cf2 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section726c95525455d11a97d4f819d29cf0d7($context, $indent, $value);
        $buffer .= $indent . '    </style>
';
        $buffer .= $indent . '</head>
';
    ...
    private function section726c95525455d11a97d4f819d29cf0d7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '            @import "https://fonts.googleapis.com/css?family=';
                $value = $this->resolveValue($context->last(), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= ':100,200,300,400,500,600,700,800,900";
';
                $context->pop();
            }
        }
