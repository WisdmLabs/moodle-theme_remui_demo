...
class __Mustache_6ecd5ee234dd0b1b21c121da7dc917dc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= '">
';
        $buffer .= $indent . '    <div class="d-flex flex-column h-100 view-contacts-wrapper">
';
        $buffer .= $indent . '        <div class="contact-list-wrapper">
';
        $buffer .= $indent . '            <ul class="nav nav-tab nav-justified m-0 contact-list-tab" role="tablist">
';
...
';
        ...
        $buffer .= '"
';
        $buffer .= $indent . '                        class="nav-link text-link-regular show-contacts-section active"
';
...
';
        ...
        $buffer .= '"
';
        $buffer .= $indent . '                        class="nav-link text-link-regular"
';
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '                        <span class="badge edw-msg-panel-badge ';
