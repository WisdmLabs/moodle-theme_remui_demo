...
class __Mustache_f1977ce8e0b1c2abb490883f765f844c extends Mustache_Template
{
...
';
        if ($parent = $this->mustache->loadPartial('core_message/message_drawer_view_overview_section')) {
            $context->pushBlockContext(array(
                ...
                'emptymessage' => array($this, 'blockDe8efbccc002936e9262de02df96fc0b'),
            ));
...
';
    ...
    public function blockDe8efbccc002936e9262de02df96fc0b($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '        <p class="text-muted edw-header-color">';
        $value = $context->find('str');
