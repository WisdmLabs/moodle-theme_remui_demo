...
class __Mustache_3f33d8c360ad7313caafa70d8c0432a0 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="col-md-3 fp-repo-area nav nav-tabs-bleft flex-column" role="tablist">
';
        $buffer .= $indent . '            <div class="fp-repo nav-item" role="tab" aria-selected="false" tabindex="-1">
';
        $buffer .= $indent . '                <a href="#" class="nav-link" tabindex="-1">
';
        $buffer .= $indent . '                    <div class="icon-container">
';
        $buffer .= $indent . '                        <img class="fp-repo-icon" alt=" " width="16" height="16" />
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                    <span class="fp-repo-name"></span>
';
        $buffer .= $indent . '                </a>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="col-md-9 fp-repo-items-container">
';
        $buffer .= $indent . '            <div class="fp-repo-items" tabindex="0">
';
        $buffer .= $indent . '                <div class="fp-navbar bg-faded card  clearfix icon-no-spacing">
';
        $buffer .= $indent . '                    <div class="fp-navbar-menus d-flex justify-content-between align-items-center">
';
        $buffer .= $indent . '                        <div class="fp-toolbar d-flex align-items-center">
';
        $buffer .= $indent . '                            <div class="fp-tb-back edw-fp-tb-icons">
';
...
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <div class="fp-tb-search edw-fp-tb-icons">
';
        $buffer .= $indent . '                                <form class="m-0"></form>
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <div class="fp-tb-refresh edw-fp-tb-icons">
';
...
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <div class="fp-tb-logout edw-fp-tb-icons">
';
        $buffer .= $indent . '                                <a title="';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <div class="fp-tb-manage edw-fp-tb-icons">
';
        $buffer .= $indent . '                                <a title="';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <div class="fp-tb-help edw-fp-tb-icons">
';
        $buffer .= $indent . '                                <a title="';
        $value = $context->find('str');
...
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <div class="fp-tb-message edw-fp-tb-icons"></div>
';
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '                        <div class="fp-viewbar btn-group float-sm-right flex-gap-4 edw-fp-tb-icons">
';
...
';
        $buffer .= $indent . '                        </div>
';
        $buffer .= $indent . '                        <div class="fp-clear-left d-none"></div>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                    <div class="fp-pathbar">
';
        $buffer .= $indent . '                        <span class="fp-path-folder "><span class="edw-icon edw-icon-Folder"></span><a class="fp-path-folder-name aalink" href="#"></a></span></span>
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                </div>
