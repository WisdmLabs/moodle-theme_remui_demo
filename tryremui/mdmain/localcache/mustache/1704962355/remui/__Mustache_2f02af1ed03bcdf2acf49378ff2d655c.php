...
class __Mustache_2f02af1ed03bcdf2acf49378ff2d655c extends Mustache_Template
{
...
';
        $buffer .= $indent . '>
';
        $buffer .= $indent . '    <div class="hidden p-px-6 p-py-4" data-region="content-messages-footer-container">
';
