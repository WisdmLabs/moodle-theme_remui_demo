...
class __Mustache_35cb3df608e5b88aadaed887cd0dcc5c extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="border-bottom" data-region="all-contacts-container">
';
        $buffer .= $indent . '        <div data-region="contacts-container"  class="pt-2">
';
        $buffer .= $indent . '            <h5 class="h-semibold-5 pt-2 p-px-6 edw-header-color">';
        $value = $context->find('str');
        $buffer .= $this->sectionAe27671d8d1750e9af3adcc5df1cbf0d($context, $indent, $value);
        $buffer .= '</h5>
';
        $buffer .= $indent . '            <div class="list-group edw-msg-body-list" data-region="list"></div>
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div data-region="non-contacts-container" >
';
        $buffer .= $indent . '            <h5 class="h-semibold-5 pt-2 p-px-6 m-0 edw-header-color">';
        $value = $context->find('str');
