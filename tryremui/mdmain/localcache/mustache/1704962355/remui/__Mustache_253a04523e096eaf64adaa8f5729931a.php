...
class __Mustache_253a04523e096eaf64adaa8f5729931a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section088defa61c0589d39870f93b84d506e1($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionC4f166e248690205119486a061cd82f2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <li {{#overlimit}}class="overlimit"{{/overlimit}}>
                <a href="{{viewurl}}" class="badge badge-primary {{#isstandard}}standardtag{{/isstandard}}" >
                {{#flag}}
                    <span class="flagged-tag">{{name}}</span></a>
                {{/flag}}
                {{^flag}}
...
';
    ...
    private function section088defa61c0589d39870f93b84d506e1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionC4f166e248690205119486a061cd82f2($context, $indent, $value);
