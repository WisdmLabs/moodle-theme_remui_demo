...
class __Mustache_abf5af49af69dac9dbbdc49b8c59cd89 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'headeractions' => array($this, 'block71edf0fd1c6676473d6e4d5841a6d7a7'),
...
';
    ...
    public function block71edf0fd1c6676473d6e4d5841a6d7a7($context)
    {
        $indent = $buffer = '';
        $buffer .= '        <a class="mark-all-read-button edw-paragraph-color  text-link-regular"
';
        $buffer .= $indent . '           href="#"
';
        $buffer .= $indent . '           title="';
...
';
        ...
        $buffer .= '">
';
        $buffer .= $indent . '            <p class="m-0 text-link-regular">Mark all read</p>
';
