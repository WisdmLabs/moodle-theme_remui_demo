...
define([
    ...
    function publishCurrentPage() {
        ...
        ModalFactory.create({
            type: ModalFactory.types.SAVE_CANCEL,
            title: Str.get_string('pagepublishmodalhead', 'local_edwiserpagebuilder'),
            body: Str.get_string('pagepublishmodaldesc', 'local_edwiserpagebuilder'),
        })
        .done(function(modal) {
