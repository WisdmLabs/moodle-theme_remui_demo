...
class ReviewManager {
    ...
    public function get_approval_compatible_data($reviews) {
        ...
        foreach ($reviews as $key => $review) {
            ...
            $temp["reviewfor"] = "<div class='ellip ellip-5 sorting_1'>" . $this->get_coursename($review->for_id) . "</div>";
            $temp["name"] = $user->firstname . " " . $user->lastname;
            $temp["email"] = $user->email;
            $temp["review"] = "<div class='ellip ellip-5'>" . (($review->review == "") ? "-" : $review->review) . "<div>";
