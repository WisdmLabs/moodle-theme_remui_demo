...
if ($data == "migrate") {
    ...
    if (!$sectionempty) {
        ...
        echo "<div class='text-center'><h2>" .get_string('homepagemigrationtitlemsg', 'local_edwiserpagebuilder'). "</h2></div>";
        echo "<div class='text-center  mb-25 mx-auto'>
        <br>";
        echo "<span  id='import-status'>" . $msg . "</span></div>";
