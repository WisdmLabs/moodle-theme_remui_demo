...
define('local_edwiserpagebuilder/components-edwiser', ['local_edwiserpagebuilder/jquery', 'core/ajax'], function (jQuery, Ajax) {
    ...
    function addBlocks(blocks, edwiserfrompreview) {
        ...
        var edwsiercncjs  = ``;
        // var edwsiercncjs = `<script src = "../../local/edwiserpagebuilder/js/slick.min.js"></script><script>$(document).ready((function(){$("#all-courses-category-carousel-{{instid}}").parents(".edw-limitedwidth-block").length>0?$("#all-courses-category-carousel-{{instid}}").slick({slidesToShow:2,slidesToScroll:1,prevArrow:$(".carousel-control-prev"),nextArrow:$(".carousel-control-next"),dots:!0,dotsClass:"carousel-indicators",responsive:[{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1}}]}).on("setPosition",(function(s,o){o.$slides.css("height",o.$slideTrack.height()+"px"),$(".slick-slide > div").css("height","100%")})):$("#all-courses-category-carousel-{{instid}}").slick({slidesToShow:4,slidesToScroll:1,prevArrow:$(".carousel-control-prev"),nextArrow:$(".carousel-control-next"),dots:!0,dotsClass:"carousel-indicators",responsive:[{breakpoint:1200,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:1024,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1}}]}).on("setPosition",(function(s,o){o.$slides.css("height",o.$slideTrack.height()+"px"),$(".slick-slide > div").css("height","100%")}))}));</script>`
        ...
        init: function (formavailable) {
            if (formavailable) {
                require(['local_edwiserpagebuilder/edwiserfrompreview'], function(edwiserfrompreview){
                    var blocks = ["html/modal", "html/courses", "html/categories", "html/edwiserform", "html/edwisercnc"];
                    addBlocks(blocks, edwiserfrompreview);
                });
            } else {
                var blocks = ["html/modal", "html/courses", "html/categories", "html/edwisercnc"];
                addBlocks(blocks);
            }
        }
    }
