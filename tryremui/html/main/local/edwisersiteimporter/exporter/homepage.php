...
$homepage = get_config('local_remuihomepage', 'defaulthomepage');
if (!is_number($homepage)) {
    $homepage = 0;
}
$homepage = optional_param('homepage', $homepage, PARAM_INT);

// Getting all sections.
$sections = $DB->get_records('remuihomepage_sections', ['homepage' => $homepage]);

if (count($sections) == 0) {
    throw new moodle_exception('Invalid homepage');
    die;
}
